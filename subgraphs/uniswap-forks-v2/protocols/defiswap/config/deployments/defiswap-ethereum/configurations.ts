...
export class DefiswapMainnetConfigurations implements Configurations {
  getNetwork(): string {
  ...
  getFactoryAddress(): string {
    return "0x9deb29c9a4c7a88a3c0257393b7f3335338d9a9d";
  }

  getFactoryContract(): Factory {
    return Factory.bind(
      Address.fromString("0x9deb29c9a4c7a88a3c0257393b7f3335338d9a9d")
    );
  }
