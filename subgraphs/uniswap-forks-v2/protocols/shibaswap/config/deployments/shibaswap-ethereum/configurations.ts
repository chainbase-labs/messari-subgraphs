...
export class ShibaswapMainnetConfigurations implements Configurations {
  getNetwork(): string {
  ...
  getFactoryAddress(): string {
    return "0x115934131916c8b277dd010ee02de363c09d037c";
  }

  getFactoryContract(): Factory {
    return Factory.bind(
      Address.fromString("0x115934131916c8b277dd010ee02de363c09d037c")
    );
  }
