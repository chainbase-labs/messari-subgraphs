...
export class OrionMainnetConfigurations implements Configurations {
  getNetwork(): string {
  ...
  getFactoryAddress(): string {
    return "0x5fa0060fcfea35b31f7a5f6025f0ff399b98edf1";
  }

  getFactoryContract(): Factory {
    return Factory.bind(
      Address.fromString("0x5fa0060fcfea35b31f7a5f6025f0ff399b98edf1")
    );
  }
