...
import {
  ...
  createConverterBaseRevertsFunctions,
  createConverterRemove,
  createConverterUpgrader,
  createConvertibleTokenAdd,
  createSmartTokenAdd,
...
import {
  handleConverterAddition,
  handleConverterRemoval,
  handleConvertibleTokenAdded,
  handleSmartTokenAdded,
} from "../../src/mappings/converterRegistry1";
import { handleConverterUpgrade } from "../../src/mappings/converterUpgrader";
...
describe("converter", () => {
  ...
  test("handleConverterRegistry", () => {
    ...
    createSmartTokenBaseFunction(
      ...
      18,
      "0.3",
      "0x6b2c2db78Fc5F1f0A7a7a6d91d26922850A9C693",
      "Token 0.1",
      true
    );
    handleConverterAddition(event);
  ...
  test("handleConversion", () => {
    let address = "0x1e45ff6c529dd038e75767779d12b7981311b8df";
    let txHash =
      "0x02ca8397bc6e0525797ce876c3ada8e234ab4b79361847dba9fb4f1f7fa727dd";
    let smartToken = "0x334C36Be5b1EaF0C4b61dDEa202c9f6Dc2640FE5";
    let blockNum = "7848031";
    ...
    let toToken = "0x6c37Bf4f042712C978A73e3fd56D1F5738dD7C43";
